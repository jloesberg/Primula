...
```{r}
pred.dat <- expand.grid(log.ros.area = seq(min(primula$log.ros.area, na.rm = TRUE), max(primula$log.ros.area, na.rm = TRUE), by = .1), summer.mean.temp = c(-1, 0, 1), pflower = c("0","1"), trt = c("irrigated", "control", "drought"))
...
irrgrowth <- ggplot(data = subset(primula, !is.na(pflower) & trt == "irrigated"), aes(x = log.ros.area, y = log.ros.areaT1))+
  ...
  geom_line(data = subset(pred.dat.output, trt == "irrigated"), aes(x = log.ros.area, y = log.ros.areaT1, color = as.character(summer.mean.temp), linetype = pflower),linewidth = 1)+
  #facet_wrap(~summer.mean.temp.scale)+
  scale_color_manual(values = c("royalblue4", "grey", "indianred3"), name = "")+
...
cgrowth <- ggplot(data = subset(primula, !is.na(pflower) & trt == "control"), aes(x = log.ros.area, y = log.ros.areaT1))+
  ...
  geom_abline(slope=1, intercept = 0, linetype = 2, color= "grey", linewidth = 1)+
  geom_line(data = subset(pred.dat.output, trt == "control"), aes(x = log.ros.area, y = log.ros.areaT1, color = as.character(summer.mean.temp), linetype = pflower),linewidth = 1)+
  #facet_wrap(~summer.mean.temp.scale)+
  scale_color_manual(values = c("royalblue4", "grey", "indianred3"), name = "")+
  scale_linetype_manual(values=c("dashed", "solid")) +  
  scale_y_continuous(expand = c(0, 0), limits = c(0, 6))+
...
drgrowth <- ggplot(data = subset(primula, !is.na(pflower) & trt == "drought"), aes(x = log.ros.area, y = log.ros.areaT1))+
  ...
  geom_abline(slope=1, intercept = 0, linetype = 2, color= "grey", linewidth = 1)+
  geom_line(data = subset(pred.dat.output, trt == "drought"), aes(x = log.ros.area, y = log.ros.areaT1, color = as.character(summer.mean.temp), linetype = pflower),linewidth = 1)+
  #facet_wrap(~summer.mean.temp.scale)+
  scale_color_manual(values = c("royalblue4", "grey", "indianred3"), name = "")+
  scale_linetype_manual(values=c("dashed", "solid")) +  
  scale_y_continuous(expand = c(0, 0), limits = c(0, 6))+
...
together <- irrgrowth + cgrowth +  drgrowth + plot_layout(guides = "collect", ncol = 3) + plot_annotation(tag_levels = 'A')
ggsave(plot = together, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/climate vital rate selection/growthVR.png", width = 11, height = 6, dpi = 300)
...
temp.minus1 <- 
  ...
  geom_point(alpha = 0.25)+
  geom_abline(slope=1, intercept = 0, linetype = 2, color= "grey", linewidth = 1)+
  geom_line(data = subset(pred.dat.output, summer.mean.temp == -1), aes(x = log.ros.area, y = log.ros.areaT1, color = trt, linetype = pflower),size = 1)+
  #facet_wrap(~summer.mean.temp.scale)+
...
temp0 <- ggplot(data = subset(primula, !is.na(pflower)), aes(x = log.ros.area, y = log.ros.areaT1))+
  geom_point(alpha = 0.25)+
  geom_abline(slope=1, intercept = 0, linetype = 2, color= "grey", size = 1)+
  geom_line(data = subset(pred.dat.output, summer.mean.temp == 0), aes(x = log.ros.area, y = log.ros.areaT1, color = trt, linetype = pflower),size = 1)+
  #facet_wrap(~summer.mean.temp.scale)+
  scale_color_manual(values = c(Z[1], Z[3], Z[5]))+
  scale_linetype_manual(values=c("dashed", "solid")) +  
  scale_y_continuous(expand = c(0, 0), limits = c(0, 6))+
...
together_flipped <- temp.minus1 + temp0 +  temp1 + plot_layout(guides = "collect", ncol = 3) + plot_annotation(tag_levels = 'A')
ggsave(plot = together_flipped, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/climate vital rate selection/growth together_flipped.png", width = 10, height = 6, dpi = 300)
...
pred.dat <-  expand.grid(log.ros.area = seq(min(primula$log.ros.area, na.rm = TRUE), max(primula$log.ros.area, na.rm = TRUE), by = .1), pflower = c("0","1"), grow.season.mean.temp = c(-1, 0, 1))
pred.output <- predict(fm.gs.av.temp.cor.int1, newdata = pred.dat, type="response", re.form=~0) #re.form = ~0 tells it to not include random effects
pred.output <- as.data.frame(pred.output)
pred.dat.output <- cbind(pred.dat, pred.output) %>% 
...
newmodel <- ggplot(subset(primula,!is.na(pflowerT1) & !is.na(pflower)), aes(x = log.ros.area, y = as.numeric(pflowerT1) - 1)) +
  geom_jitter(height = .15, alpha = 0.22) +
  #scale_color_manual(values = c("lightsteelblue3", "grey0")) +
  geom_line(data = subset(pred.dat.output, pflower == "0" & grow.season.mean.temp == 0), aes(x = log.ros.area, y = pflowerT1), linetype = "dashed", color = "grey", size = 1) +
  geom_line(data = subset(pred.dat.output, pflower == "1" & grow.season.mean.temp == 0), aes(x = log.ros.area, y = pflowerT1), color = "grey", size = 1) +
  geom_line(data = subset(pred.dat.output, pflower == "0" & grow.season.mean.temp == 1), aes(x = log.ros.area, y = pflowerT1), linetype = "dashed", color = "indianred", size = 1) +
  geom_line(data = subset(pred.dat.output, pflower == "1" & grow.season.mean.temp == 1), aes(x = log.ros.area, y = pflowerT1), color = "indianred", size = 1) +
  geom_line(data = subset(pred.dat.output, pflower == "0" & grow.season.mean.temp == -1), aes(x = log.ros.area, y = pflowerT1), linetype = "dashed", color = "royalblue4", size = 1) +
  geom_line(data = subset(pred.dat.output, pflower == "1" & grow.season.mean.temp == -1), aes(x = log.ros.area, y = pflowerT1), color = "royalblue4", size = 1) +
  scale_x_continuous(expand = c(0, 0), limits = c(0, 6)) +
  labs(x = "log(Rosette Area) in t", y = "Probability of Flowering in t + 1") +
...
rain0
rain1
ggsave(plot = newmodel, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/climate vital rate selection/4 gs temp flowering.png", width = 6, height = 6, dpi = 300)
...
#survial figure
```{r}
pred.dat <-  expand.grid(log.ros.area = seq(min(primula$log.ros.area, na.rm = TRUE), max(primula$log.ros.area, na.rm = TRUE), by = .1), grow.season.mean.temp = c(-1, 0, 1))
...
survival <- 
  ...
  geom_line(data = subset(pred.dat.output, grow.season.mean.temp == -1), aes(x = log.ros.area, y = survT1), color = "royalblue4", size = 1) +
  geom_line(data = subset(pred.dat.output, grow.season.mean.temp == 1), aes(x = log.ros.area, y = survT1), color = "indianred3", size = 1) +
  geom_line(data = subset(pred.dat.output, grow.season.mean.temp == 0), aes(x = log.ros.area, y = survT1), color = "grey", size = 1) +
  scale_x_continuous(expand = c(0, 0), limits = c(0, 6))+
  labs(x = "log(Rosette Area) in t", y = "Survival in t+1")+
  theme(axis.line = element_line(colour = 'black', linewidth = 1.1), text = element_text(size = 20))
survival
ggsave(plot = survival, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/climate vital rate selection/1survival temp.fig.png", width = 6, height = 6, dpi = 300)
...
```{r}
pred.dat <-  expand.grid(log.ros.area = seq(min(primula$log.ros.area, na.rm = TRUE), max(primula$log.ros.area, na.rm = TRUE), by = .1), winter.mean.temp = c(-1, 0, 1))
...
poisson <- 
  ...
  #geom_jitter(height = .05)+
  geom_point() +
  geom_line(data = subset(pred.dat.output, winter.mean.temp == -1), aes(x = log.ros.area, y = noflowers), color = "royalblue4", size = 1) +
  geom_line(data = subset(pred.dat.output, winter.mean.temp == 1), aes(x = log.ros.area, y = noflowers), color = "indianred3", size = 1) +
  geom_line(data = subset(pred.dat.output, winter.mean.temp == 0), aes(x = log.ros.area, y = noflowers), color = "grey", size = 1) +
  scale_x_continuous(expand = c(0, 0), limits = c(0, 6))+
  labs(x = "log(Rosette Area) in t", y = "Flowers in t+1")+
    theme(axis.line = element_line(colour = 'black', linewidth = 1.1), text = element_text(size = 20))

poisson
#ggsave(plot = poisson, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/climate vital rate selection/1no.flowers winter temp.fig.png", width = 5, height = 5, dpi = 300)
