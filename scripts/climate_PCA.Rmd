...
climate2 <- climate %>% 
  rename(Sp_Precip = spring.tot.precip,
         Wt_Precip = winter.tot.precip,
         Su_Precip = summer.tot.precip,
         Fa_Precip = fall.tot.precip,
         Sp_MeanT = spring.mean.temp,
         Sp_MaxT = spring.mean.max.temp,
         Sp_MinT = spring.mean.min.temp,
          Wt_MeanT = winter.mean.temp,
         Wt_MaxT = winter.mean.max.temp,
         Wt_MinT = winter.mean.min.temp,
         Su_MeanT = summer.mean.temp,
         Su_MaxT = summer.mean.max.temp,
         Su_MinT = summer.mean.min.temp,
         Fa_MeanT = fall.mean.temp,
         Fa_MaxT = fall.mean.max.temp,
         Fa_MinT = fall.mean.min.temp)
...
M<-cor(climate2[,-1])
res1 <- cor.mtest(climate2[,-1], conf.level = 0.95)
...
pairs(climate2[,-1], upper.panel = NULL, pch = 20, cex = 1.5)
