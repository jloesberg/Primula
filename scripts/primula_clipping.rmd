...
pred.dat <-  expand.grid(log.ros.area = seq(2, 5.5, by = .1), log.total.seeds = c(0, 1, 2, 2.5, 3, 4, 5))
...
(growth <- ggplot(clip, aes(x = log.ros.area, y = log.ros.areaT1))+
  ...
  scale_color_gradient2(midpoint = 2.5, low = "orchid1", mid = "darkorchid2",
                            high = "darkorchid4", space = "Lab" )+
  geom_line(data = subset(pred.dat.output, log.total.seeds == 5), aes(x = log.ros.area, y = log.ros.areaT1), color = "darkorchid4", linewidth = 1.5)+
  #geom_line(data = subset(pred.dat.output, log.total.seeds == 4), aes(x = log.ros.area, y = log.ros.areaT1), color = "darkorchid3")+
  geom_line(data = subset(pred.dat.output, log.total.seeds == 3), aes(x = log.ros.area, y = log.ros.areaT1), color = "darkorchid2", linetype = "longdash", linewidth = 1.5)+
 # geom_line(data = subset(pred.dat.output, log.total.seeds == 2), aes(x = log.ros.area, y = log.ros.areaT1), color = "darkorchid1")+
  geom_line(data = subset(pred.dat.output,  log.total.seeds == 1), aes(x = log.ros.area, y = log.ros.areaT1), color = "orchid1", linetype = "dashed", linewidth = 1.5)+
...
(growth2 <- ggplot(clip, aes(x = log.ros.area, y = log.ros.areaT1))+
 ...
 # geom_line(data = subset(pred.dat.output.g, log.total.seeds == 2), aes(x = log.ros.area, y = log.ros.areaT1), color = "darkorchid1")+
  #geom_line(data = subset(pred.dat.output.g,  log.total.seeds == 1), aes(x = log.ros.area, y = log.ros.areaT1, color = log.total.seeds), linetype = "dashed", linewidth = 1.5)+
  ...
  #scale_color_manual(breaks = c(0, 2.5, 5), values = c("orchid1", "darkorchid2","#5e1d7e"), labels = c("0", "12", "150"))+
  scale_color_gradient2(midpoint =2.5, low = "orchid1", mid = "darkorchid2",
...
growth2
ggsave(plot = growth2, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/clipping experiment/6growth result fig.png", width =6, height =5, dpi = 300)
```
