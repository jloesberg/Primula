...
write_csv(gr.AIC, "./Figures/clipping experiment/tables/growth AIC table.csv")
...
growth
ggsave(growth, "./Figures/clipping experiment/round 2/growth.png", width = 4, height = 4, dpi = 72)
