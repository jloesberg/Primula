...
growth_var <- as.data.frame(VarCorr(gm.summer.av.temp.cor.trt.int6)) #assumes same variance across all, not sure if thats ok
coef(summary(gm.summer.av.temp.cor.trt.int6))
...
rows <- expand.grid(summer.precip= seq(-2, 2, by = .5), summer.temp = seq(-2, 2, by = .5), gs.temp = seq(-2, 2, by = .5),  winter.temp = seq(-2, 2, by = .5), reproduction = c("veg","flowered"), trt = c("control", "drought", "irrigated"))
...
#growth intercepts
for (i in 1:6561) {
    params$growth.int[params$reproduction == "veg" & params$trt == "control"][i] <- fixef(gm.summer.av.temp.cor.trt.int6)[1] + fixef(gm.summer.av.temp.cor.trt.int6)[6]*params$summer.temp[i]

    params$growth.int[params$reproduction == "flowered" & params$trt == "control"][i] <- fixef(gm.summer.av.temp.cor.trt.int6)[1] + fixef(gm.summer.av.temp.cor.trt.int6)[6]*params$summer.temp[i] + fixef(gm.summer.av.temp.cor.trt.int6)[3]

    params$growth.int[params$reproduction == "veg" & params$trt == "irrigated"][i] <- fixef(gm.summer.av.temp.cor.trt.int6)[1] + fixef(gm.summer.av.temp.cor.trt.int6)[6]*params$summer.temp[i] + fixef(gm.summer.av.temp.cor.trt.int6)[5] + fixef(gm.summer.av.temp.cor.trt.int6)[8]*params$summer.temp[i]
    params$growth.int[params$reproduction == "flowered" & params$trt == "irrigated"][i] <- fixef(gm.summer.av.temp.cor.trt.int6)[1] + fixef(gm.summer.av.temp.cor.trt.int6)[6]*params$summer.temp[i] + fixef(gm.summer.av.temp.cor.trt.int6)[3] + fixef(gm.summer.av.temp.cor.trt.int6)[5] + fixef(gm.summer.av.temp.cor.trt.int6)[8]*params$summer.temp[i]
    
    params$growth.int[params$reproduction == "veg" & params$trt == "drought"][i] <- fixef(gm.summer.av.temp.cor.trt.int6)[1] + fixef(gm.summer.av.temp.cor.trt.int6)[6]*params$summer.temp[i] + fixef(gm.summer.av.temp.cor.trt.int6)[4] + fixef(gm.summer.av.temp.cor.trt.int6)[7]*params$summer.temp[i]
    params$growth.int[params$reproduction == "flowered" & params$trt == "drought"][i] <- fixef(gm.summer.av.temp.cor.trt.int6)[1] + fixef(gm.summer.av.temp.cor.trt.int6)[6]*params$summer.temp[i] + fixef(gm.summer.av.temp.cor.trt.int6)[3] + fixef(gm.summer.av.temp.cor.trt.int6)[4] + fixef(gm.summer.av.temp.cor.trt.int6)[7]*params$summer.temp[i]
...
#sm.gs.av.temp
for (i in 1:length(params$gs.temp)) {
  params$surv.int[i] <- fixef(sm.gs.av.temp)[1] + fixef(sm.gs.av.temp)[3]*params$gs.temp[i]
}
 # survival slope
params$surv.slope <- fixef(sm.gs.av.temp)[2] # survival size t

#pflower
# intercepts - this doesnt really work - maybe i need a tidyverse solution (group by?)
for (i in 1:6561) {
    params$pflow.int[params$reproduction == "veg" & params$trt == "control"][i] <- fixef(fm.summer.precip.cor.trt.int6)[1] + fixef(fm.summer.precip.cor.trt.int6)[6]*params$summer.precip[i]
    params$pflow.int[params$reproduction == "flowered" & params$trt == "control"][i] <- fixef(fm.summer.precip.cor.trt.int6)[1] + fixef(fm.summer.precip.cor.trt.int6)[6]*params$summer.precip[i] + fixef(fm.summer.precip.cor.trt.int6)[3]

    params$pflow.int[params$reproduction == "veg" & params$trt == "irrigated"][i] <- fixef(fm.summer.precip.cor.trt.int6)[1] + fixef(fm.summer.precip.cor.trt.int6)[6]*params$summer.precip[i] + fixef(fm.summer.precip.cor.trt.int6)[5] + fixef(fm.summer.precip.cor.trt.int6)[9]*params$summer.precip[i]
    params$pflow.int[params$reproduction == "flowered" & params$trt == "irrigated"][i] <- fixef(fm.summer.precip.cor.trt.int6)[1] + fixef(fm.summer.precip.cor.trt.int6)[6]*params$summer.precip[i] + fixef(fm.summer.precip.cor.trt.int6)[3] + fixef(fm.summer.precip.cor.trt.int6)[5] + fixef(fm.summer.precip.cor.trt.int6)[9]*params$summer.precip[i]
    
    params$pflow.int[params$reproduction == "veg" & params$trt == "drought"][i] <- fixef(fm.summer.precip.cor.trt.int6)[1] + fixef(fm.summer.precip.cor.trt.int6)[6]*params$summer.precip[i] + fixef(fm.summer.precip.cor.trt.int6)[4] + fixef(fm.summer.precip.cor.trt.int6)[8]*params$summer.precip[i]
    params$pflow.int[params$reproduction == "flowered" & params$trt == "drought"][i] <- fixef(fm.summer.precip.cor.trt.int6)[1] + fixef(fm.summer.precip.cor.trt.int6)[6]*params$summer.precip[i] + fixef(fm.summer.precip.cor.trt.int6)[3] + fixef(fm.summer.precip.cor.trt.int6)[4] + fixef(fm.summer.precip.cor.trt.int6)[8]*params$summer.precip[i]
...
#slopes:
#for (i in 1:length(params)) {
  params$pflow.slope[params$reproduction == "veg"] <- fixef(fm.summer.precip.cor.trt.int6)[2]
  params$pflow.slope[params$reproduction == "flowered"]<- fixef(fm.summer.precip.cor.trt.int6)[2] + fixef(fm.summer.precip.cor.trt.int6)[7]
#}
...
for (i in 1:39366) {
    params$no.flow.int[i] <- fixef(noflowers.winter.av.temp)[1] + fixef(noflowers.winter.av.temp)[3]*params$winter.temp[i]
}
...
params$recruit.size.sd<- new_sd # sd of new >1 leaf plant size
 ...
 test <- params %>% filter(summer.precip == 0 & summer.temp == 0 & gs.temp == 0 & winter.temp ==0)
...
x = 0
test <- lapply(X = params_list, FUN = bigmatrix, mat.size = mat.size)
f.yx(y,params_list)
...
#params_list <- params_list[1] #to test it!
# BIGMATRIX ---------------------------------------------------------------
...
bigmatrix<-function(params_list, mat.size)
  ...
  out_lamb <- data.frame(lambda = lambda(IPMmat), summer.precip = params_list$summer.precip, summer.temp = params_list$summer.temp,  gs.temp = params_list$gs.temp, winter.temp = params_list$winter.temp, reproduction = params_list$reproduction, trt = params_list$trt)
...
sp <- primula_lambda %>% 
  ...
  scale_linetype_manual(values = c("dashed", "solid"), labels = c("no cost", "cost"), name = "")+
  labs(y = expression(paste("\u03BB")), x = "Summer Precipitation")
st <- primula_lambda %>% 
  filter(near(summer.precip, 0, tol = .1)) %>% 
  filter(near(gs.temp, 0, tol = .1)) %>% 
  filter(near(winter.temp, 0, tol = .2)) %>% 
...
#ggsave(plot = sp, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/IPM/sp.png", width = 7, height = 6, dpi = 300)
#ggsave(plot = st, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/IPM/st.png", width = 7, height = 6, dpi = 300)
#ggsave(plot = gst, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/IPM/gst.png", width = 7, height = 6, dpi = 300)
#ggsave(plot = wt, file = "C:/Users/Jenna/OneDrive - The University Of British Columbia/Data Projects/Primula/Figures/IPM/wt.png", width = 7, height = 6, dpi = 300)
