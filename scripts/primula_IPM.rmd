...
bigmatrix<-function(params, mat.size)
  {
  n<-mat.size
  L<-min.size
  U<-max.size
  ...
  Fmat[1,3:(n+2)]<-f.yx.flowered(y,params) #This is a y because it is the fecundity kernel for plants that have already grown/survived, I think? It's what Tom has
  ...
  Tmat[3:(n+2),3:(n+2)]<- t(outer(y,y,P.control,params=params)) * h 
